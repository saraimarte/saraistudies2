...
**The goal for SRM:** measure and identify which suppliers can be my strategic partners and then work with them to get the benefits that will improve the company and reduce costs. To maximize the value of the relationship we have with them.  
...
(3) serve in *many* parts of the company (as in, you depend on them a lot.)  
...
**Weighted Criteria Evaluation System:** Where we create performance mesures like cost, collect data on those measures, assign weights, and calculate the score and compare it to a target score.   
...
(2) **External Certification Program:** sometimes companies don't have the money or resources to ceretify themselve so they require the suppliers to certify using external agencies and get a certificaiton of ISO 9000/ ISO 14000.  
...
Note: You don't need to know all 8 principles of ISO 9000 just the stuff above. 
...
If we have a supplier that provides me the cartons for toothpaste but they don't have the knowledge of making the Colgate you can help them develop the skills to do that aswell like investing in their training or providing them information. This is beneficial for us because now they can help you more and helps the supplier because they have new skills they can offer to other companies too.   
