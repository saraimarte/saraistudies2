...
This is saying, "Hey, I want to store the output of this program in data.txt"
...
This is saying, "Hey, I want to use info from data.txt in my program."
...
This is saying, "Hey, I want to use the output of the program in fileName1 in this program
fileName2"
...
The pointy part is pointing to data.txt so the data is going into data.txt.

&nbsp;&nbsp;&nbsp;&nbsp;

In java fileName1 < fileFromTheInterent.txt,

&nbsp;&nbsp;&nbsp;&nbsp;

the pointy part is pointing to fileName1 meaning the data from fileFromTheInterent is going into
fileName1.
