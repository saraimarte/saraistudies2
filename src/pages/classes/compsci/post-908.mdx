...
title: 🟡 Object Oriented Programming (OOP) - Primitive vs Abstract Data Types
date: 04/19/24
author: Sarai Marte
chapter: Week 
---
...
```java 
    ...
    //Output: 0 b/c sarai is not the same as sarai
...
2.Given any string, output how frequent a certain character shows up.
