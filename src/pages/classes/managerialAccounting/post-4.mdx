...
title: Chapter 4 | Why and How do we allocate OH? How do we deal with under/overallocation?
date: 02/16/2024
author: Sarai Marte
---
import imgurl1 from "../../../../public/Images/KrispyPizza.png";
import imgurl2 from '../../../../public/Images/2751.png';
import imgurl3 from '../../../../public/Images/2758.png';
import imgurl4 from '../../../../public/Images/2759.png';
import imgurl5 from '../../../../public/Images/27510.png';
import imgurl6 from '../../../../public/Images/27511.png';
import imgurl7 from '../../../../public/Images/27512.png';
import imgurl8 from '../../../../public/Images/27513.png';
import Table1 from '../../../components/Table1.astro';
import Table2 from '../../../components/Table2.astro';
import Table3 from '../../../components/Table3.astro';
...
So, if we planned to make 5000 pizzas and our BOHR is $2, you would think your allocated OH would be $2 OH x 5000 pizzas = <b>$10,000</b> allocated OH at the end of the year. Wrong. This is your <b> budgeted (planned/estimated) allocated OH </b> This is what you plan to allocate.
...
Notice how it's impossible to know what your actual OH is going to be at the end of the year at the start, because it's based on what your actual driver is and what your actual costs are going to be at the end of the year which you <i> also </i> don't know. Which is why we estimate these numbers in the beginning and then at the end of the year we adjust for any differences.

&nbsp;&nbsp;&nbsp;&nbsp;

When people use 'actual' numbers they use previous years numbers and we call this actual costing when you use actual numbers. Normal costing is when we use budgeted numbers to get the BOHR.
...
Here, we are  distributing the under across all accounts based on how much of the total OH they each take up. 
...
For example, if all the costs of Krispy Pizza are in the range of $500,000 or $100,000 and we get an under/over of $5 then that $5 is obviously not signficant hence not material so we just write it off to COGS because it's really not that important to be more precise in distributing the $5. 

&nbsp;&nbsp;&nbsp;&nbsp;

If the under/over is $100,000 then is is sigficant/material in comparison with the rest of the costs of Krispy Pizza.
